...
function playSound(type) {
    ...
    try {
        ...
        if (type === "jump") {
            // Zıplama: hızlı yükselen frekans
            ...
            // Level tamamlama: zafer melodisi
...
function createSoundButton() {
    ...
    btn.onclick = () => {
        ...
        btn.innerHTML = soundEnabled ? "🔊" : "🔇";
        if (soundEnabled) playSound("diamond"); // test sesi
    };
    document.body.appendChild(btn);
}

document.addEventListener("DOMContentLoaded", createSoundButton);
if (document.readyState !== "loading") createSoundButton();
// Global erişim için window'a bağla (player.js vb. kullanabilsin)
